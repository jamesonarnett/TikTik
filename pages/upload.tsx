...
const Upload = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg xl:h-[80vh] sm:w-[90%] lg:w-[85%]
      ...
      >
                ...
                {videoAsset ? (
                  ...
                  <label className="cursor-pointer">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p
                        className="bg-[#F51997] text-center mt-10 rounded text-white text-md
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <select
            className="outline-none bg-white border-2 border-gray-200
          ...
          >
            {topics.map((topic) => (
              <option
                key={topic.name}
                className="outline-none capitalize text-gray-700
                text-md hover:bg-slate-100"
                value={topic.name}
              >
                {topic.name}
              </option>
